/**
 * Static onboarding that saves to localStorage via PrefsProvider
 * instead of making API calls.
 */
import { useState } from "react";
import { usePrefs } from "@/lib/preferences-context";
...
import { SiReddit, SiYoutube, SiTiktok } from "react-icons/si";
...
export function StaticOnboarding({ onComplete }: OnboardingProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background/95 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-card border border-border rounded-xl shadow-xl max-w-md w-full p-6 md:p-8">
        {/* Progress dots */}
        ...
        <div className="min-h-[320px]">
          {step === "welcome" && (
            <div className="flex flex-col items-center text-center" data-testid="step-welcome">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed max-w-[320px]">
                Your personalized social media trend aggregator. Let's set up
                your feed in a few quick steps.
              </p>
            </div>
          )}
          ...
          {step === "platforms" && (
            <div data-testid="step-platforms">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                We'll pull trending posts from your selected platforms.
              </p>
          ...
          {step === "sources" && (
            <div data-testid="step-sources">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Related articles will be pulled from these sources.
              </p>
          ...
          {step === "frequency" && (
            <div data-testid="step-frequency">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Choose how frequently your feed refreshes.
              </p>
              <div className="space-y-2">
        ...
        <div className="flex items-center justify-between mt-8 pt-4 border-t border-border">
          {!isFirst ? (
            <Button variant="ghost" size="sm" onClick={goBack} data-testid="button-onboarding-back">
          ...
          <Button size="sm" onClick={goNext} data-testid="button-onboarding-next">
            {isLast ? (
              <>
